...
describe ContactController do
  ...
  describe 'POST #create' do
    context 'when the user fills out all required fields' do
      before(:each) { post :create, contact: { name: Faker::Internet.name, email: Faker::Internet.email, body: Faker::Lorem.paragraph } }
    ...
    context 'when the user does not fill out all the required fields' do
      context 'when the email is missing' do
        before(:each) { post :create, contact: { name: Faker::Internet.name, email: '', body: Faker::Lorem.paragraph } }
      ...
      context 'when the body is missing' do
        before(:each) { post :create, contact: { name: Faker::Internet.name, email: Faker::Internet.email, body: '' } }
